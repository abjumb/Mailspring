...
interface TasksListPanelState {
  tasks: ReadonlyArray<MorosTask>;
  searchQuery: string;
}

export default class TasksListPanel extends React.Component<
  Record<string, unknown>,
  TasksListPanelState
> {
  static displayName = 'TasksListPanel';

  _unlisten?: () => void;

  state: TasksListPanelState = {
